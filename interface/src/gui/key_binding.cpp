...
namespace gui {
    ...
    Key key_from_string(const char* text, const size_t length)
    {
        ...
        case 1:
            ...
            if (strncmp(text, "`", length) == 0) return Key::GRAVE;
    ...
    static void populate_cache(std::map<uint64_t, const char*>& cache) {
        ...
        cache.emplace(static_cast<uint64_t>(Key::GRAVE), "`");
        ...
        cache.emplace(static_cast<uint64_t>(KeyMod::SHIFT) << 32 | static_cast<uint64_t>(Key::GRAVE), "Shift+`");
        ...
        cache.emplace(static_cast<uint64_t>(KeyMod::CTRL) << 32 | static_cast<uint64_t>(Key::GRAVE), "Ctrl+`");
        ...
        cache.emplace(static_cast<uint64_t>(KeyMod::ALT) << 32 | static_cast<uint64_t>(Key::GRAVE), "Alt+`");
